(function () {
    ...
    function updateParticipantSelections() {
        ...
        document.querySelectorAll("select.participant-day-select").forEach(select => {
            let currentSelected = [];
            if (select.tomselect) {
        ...
        const dietaryContainer = document.getElementById("dietary-participants-container");
        if (dietaryContainer) {
            ...
            document.querySelectorAll(".dietary-options-select").forEach(el => {
                if (!el.tomselect) {
